...
from device.peripherals.common.mcp23017 import driver
from device.peripherals.modules.actuator_mcp23017 import exceptions, events


class ActuatorMCP23017Manager(manager.PeripheralManager):
    """Manages an actuator controlled by a 23017 MCP."""
    ...
    def __init__(self, *args: Any, **kwargs: Any) -> None:
        ...
        if self.port is None:
            self.logger.critical("Missing MCP port")
            return
    ...
    def initialize_peripheral(self) -> None:
        ...
        # Initialize driver
        try:
            self.driver = driver.MCP23017Driver(
                name=self.name,
