...
from device.peripherals.modules.led_arduino import driver, exceptions, events


class LEDArduinoManager(manager.PeripheralManager):
    """Manages an LED driver controlled by an ardunio"""
    ...
    def initialize_peripheral(self) -> None:
        ...
        # Initialize driver
        try:
            self.driver = driver.LEDArduinoDriver(
                name=self.name,
