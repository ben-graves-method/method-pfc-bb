...
from device.peripherals.common.arduino.driver import ArduinoDriver
from device.peripherals.modules.ardunio import exceptions
...
class LEDArduinoPanel(object):
    ...
    driver: Optional[ArduinoDriver] = None
