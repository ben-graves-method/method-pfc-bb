...
# Import python types
from typing import Optional, Tuple, Dict, Anyå

# Import peripheral parent class
from device.peripherals.classes.peripheral import manager, modes

# Import manager elements
from device.peripherals.common.arduino import driver
from device.peripherals.modules.basic_arduino import exceptions, events


class BasicActuatorManager(manager.PeripheralManager):
    ...
    def __init__(self, *args: Any, **kwargs: Any) -> None:
        ...
        self.logger.info("initializing actuator manager: name={} pin={}".format(self.name, self.pin))
    ...
    def initialize_peripheral(self) -> None:
        """Initializes manager."""
        self.logger.info("Initializing peripheral: name={} pin={}".format(self.name, self.pin))
